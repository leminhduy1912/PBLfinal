...
if (error===""){  
  ...
  const [formComment,setFormComment]= useState({typeId:"ggzbMjNlojYdZ-53gDweinl"})
  return (
    <div className='comment-form-container'>
       <div className="comment-form-content">
        ...
        <div className="form-group">
          ...
          onChange={(e)=>{setFormComment({...formComment,title:e.target.value})}}
          ...
          onChange={(e)=>{setFormComment({...formComment,content:e.target.value})}}
