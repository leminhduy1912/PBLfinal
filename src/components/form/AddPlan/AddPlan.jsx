...
await props.handleShowSuccessAction("Added New Plan")
  ...
  ><ClearIcon
  onClick={()=>{props.handleShowModalAddPlan(false)}}
  />
  </div>
        <form action="">
          ...
          <select name="" id="" onChange={(e)=>{setFormAddNewPlan({...formAddNewPlan,companyId:e.target.value})}}>
          ...
          <div className="form-group">
            ...
            <input 
            type="datetime-local"
            onChange={(e)=>{setFormAddNewPlan({...formAddNewPlan,time:ConvertToTimeStamp(e.target.value)})}} 
            />
          </div>
