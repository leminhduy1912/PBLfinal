...
export const deleteCertificateFromProduct=async(productId,certificateId,clientId,token)=>{
  return await Axios({
    method:"DELETE",
    headers: {
      ACCESS_TOKEN:token,
    ...
    url:"private/product/certificate?productId="+ productId+"&certificateId="+certificateId,
  })
}
